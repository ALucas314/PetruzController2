...
CREATE TABLE IF NOT EXISTS "OCPD" (
  ...
  -- Reprocessos (armazenados como JSONB para permitir múltiplos reprocessos)
  reprocessos             JSONB DEFAULT '[]'::jsonb,     -- Array de reprocessos: [{"numero": 1, "tipo": "Cortado", "codigo": "02366", "descricao": "...", "quantidade": 0.00}, ...]
