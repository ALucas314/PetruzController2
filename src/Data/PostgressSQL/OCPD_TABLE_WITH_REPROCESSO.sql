...
CREATE TABLE IF NOT EXISTS "OCPD" (
  ...
  -- Filial
  filial_nome             VARCHAR(255),                   -- Nome completo da filial

  -- Reprocessos
  reprocesso_numero       INTEGER,                         -- Número do Reprocesso
  reprocesso_tipo         VARCHAR(20),                    -- Tipo do Reprocesso: 'Cortado' ou 'Usado'
  reprocesso_codigo       VARCHAR(100),                   -- Código do Reprocesso
  reprocesso_descricao    TEXT,                           -- Descrição do Reprocesso
  reprocesso_quantidade   NUMERIC(15,2) DEFAULT 0,        -- Quantidade do Reprocesso
  reprocesso_total_cortado NUMERIC(15,2) DEFAULT 0,       -- Quantidade total cortada do reprocesso
  reprocesso_total_usado   NUMERIC(15,2) DEFAULT 0,       -- Quantidade total usada do reprocesso
...
COMMENT ON COLUMN "OCPD".reprocesso_numero      IS 'Número do Reprocesso';
COMMENT ON COLUMN "OCPD".reprocesso_tipo        IS 'Tipo do Reprocesso: Cortado ou Usado';
COMMENT ON COLUMN "OCPD".reprocesso_codigo       IS 'Código do Reprocesso';
COMMENT ON COLUMN "OCPD".reprocesso_descricao   IS 'Descrição do Reprocesso';
COMMENT ON COLUMN "OCPD".reprocesso_quantidade  IS 'Quantidade do Reprocesso';
COMMENT ON COLUMN "OCPD".reprocesso_total_cortado IS 'Quantidade total cortada do reprocesso';
COMMENT ON COLUMN "OCPD".reprocesso_total_usado  IS 'Quantidade total usada do reprocesso';
